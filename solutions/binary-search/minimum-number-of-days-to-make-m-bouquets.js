...
Approach
- Consider the range from 1 to maximum day as the search space.
- Divide the range into two.
- If using the mid as number of days if it is possible to make m bouquets then mark the mid as potential result and search on the left subarray.
